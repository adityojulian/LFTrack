...
class Detector {
  ...
  static const String _modelPath = 'assets/models/lft_ssd_mobile.tflite';
  static const String _labelPath = 'assets/models/lft_label.txt';
...
class _DetectorServer {
  ...
  Map<String, dynamic> analyseImage(
    ...
    final List<Rect> locations = locationsRaw
        ...
        // .map((rect) => Rect.fromLTRB(rect[1], rect[2], rect[3], rect[0]))
        .toList();
